...
import { Film, User, LogOut, LayoutDashboard, Ticket, Home, Video } from 'lucide-react'
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="p-2 bg-gradient-to-br from-cinema-red to-cinema-red-dark rounded-xl shadow-lg shadow-cinema-red/50 group-hover:shadow-cinema-red/70 transition-all duration-300">
              <Film className="w-8 h-8 text-white" />
            </div>
            <div>
              <span className="text-2xl font-bold bg-gradient-to-r from-cinema-red to-cinema-gold bg-clip-text text-transparent">
                LLMCinema
              </span>
              <div className="text-xs text-gray-500 -mt-1">Premium Experience</div>
            </div>
          </Link>
